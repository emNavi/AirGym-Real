...
void registerPub(ros::NodeHandle &n)
{
    ...
    after_filter_sub=n.subscribe("/after_filter",10,afterfiltercbck);
...
void pubLatestOdometry(const Eigen::Vector3d &P, const Eigen::Quaterniond &Q, const Eigen::Vector3d &V, double t)
{
    ...
    if (get_nokov)
    {
        ...
        std::cout<<"gap x: "<<nokov[0]-odometry.pose.pose.position.x<<"y:"<<nokov[1]-odometry.pose.pose.position.y<<"z:"<<nokov[2]- odometry.pose.pose.position.z<<std::endl;
        get_nokov=false;
    }
